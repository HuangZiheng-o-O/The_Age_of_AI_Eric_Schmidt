...
So let's say you put $50 billion of capital into a company, you have to make an awful lot of money from intelligence to pay that back. So it's probably the case that we'll go through some huge investment bubble, and then it'll sort itself out. That's always been true in the past, and it's likely to be true here. And what you said earlier was you think that the leaders are pulling away from the rest. Right now.  
...
Yeah, do you see regulators breaking up these companies and how will that affect the... Yeah. So in my career, I helped Microsoft get broken up and it wasn't broken up. And I fought for Google to not be broken up and it's not been broken up. So it sure looks to me like the trend is not to be broken up.  
...
And then thinking through what are the dynamics like Henry Kissinger was doing with Eric Schmidt in his book. If you're an economist thinking through the labor market implications, the implications for concentration, the implications for inequality and jobs, implications for productivity and what drives productivity. Those are things that are very ripe right now. And you could go through lots of different fields where there's, you know, understanding well enough what the technology might be capable of. But then thinking through the implications.  
然后像亨利-基辛格（Henry Kissinger）与埃里克-施密特（Eric Schmidt）在他的书中所做的那样，思考其中的动态。如果你是一位经济学家，你可以思考对劳动力市场的影响、对集中度的影响、对不平等和就业的影响、对生产率的影响以及推动生产率的因素。这些都是现在非常成熟的问题。你可以去很多不同的领域，你知道，这些领域对技术的能力有足够的了解。然后再思考其影响。

That's I think where some of the biggest payoffs are. I mean, let me give you a little bit more of a concrete example. And this is something I was going to talk about last week. Electricity was also a general purpose technology. And general purpose technologies have this characteristic that they're part of in and of themselves.  
我认为这就是一些最大的回报所在。让我举个更具体的例子。这也是我上周想说的。电力也是一种通用技术。通用技术有这样一个特点，它们本身就是技术的一部分。

But one of the real powers of general purpose technologies, GPTs as I was saying, is that they give complimentary, they ignite complimentary innovations. So electricity, light bulbs and computers and electric motors and electric motors give you compressors and refrigerators and air conditioning. You can just kind of have a whole set cascade of additional innovations from this one innovation. And most of the value comes from these complimentary innovations. One thing people don't appreciate enough is that some of the most important complimentary innovations are organizational and human capital complementarities.  
但是，通用技术（GPT）的真正力量之一，正如我刚才所说的，是它们带来了互补性，点燃了互补性创新。因此，电力、灯泡、计算机、电机和电动马达给你带来了压缩机、冰箱和空调。你可以从这一项创新中获得一系列附加创新。而大部分价值都来自于这些互补的创新。人们没有充分认识到的一点是，一些最重要的互补创新是组织和人力资本的互补。

So with electricity, when they first introduced electricity into factories, Paul David here at Stanford studied what happened to those factories. And surprisingly, not much. The factories when they started electrifying, they were not significantly more productive than the previous factories that were powered by steam engines. He's like, well, that's kind of weird because this seems like a pretty important technology. Is it just a fad?  
在斯坦福大学的保罗-戴维研究了工厂用电后的情况。令人惊讶的是，并没有发生什么变化。当工厂开始电气化时，它们的生产率并没有明显高于之前由蒸汽机驱动的工厂。他说，这有点奇怪，因为这似乎是一项非常重要的技术。难道这只是一种时尚？

Obviously not. The factories before electricity were powered by steam engines. They typically had a big steam engine in the middle and then crankshafts and pulleys that powered all the equipment. And it was all distributed. But you tried to have it as close to the steam engine as possible because if you make the crankshaft too long, it would break the torsion.  
显然不是。在通电之前，工厂是由蒸汽机驱动的。它们通常中间有一个大蒸汽机，然后是曲轴和滑轮，为所有设备提供动力。所有设备都是分布式的。但你要尽量让它接近蒸汽机 因为如果曲轴太长 就会破坏扭力

When they introduced electricity, he found that in factory after factory, they would pull out the steam engine and they would get the biggest electric motor they could find and put it where the steam engine used to be and fire it up. But you know, it didn't really change production a whole lot. You can see that that's not a big deal. So then they started building entirely new factories from scratch in a new location. What did those look like?  
当引入电力后，他发现在一家又一家的工厂里，他们会把蒸汽机拆掉，然后找来最大的电动机，放在原来蒸汽机的位置，然后点火。但你知道，这并没有真正改变生产。你可以看到，这并不是什么大事。于是，他们开始在新的地方从头开始建造全新的工厂。这些工厂是什么样的？
...
就像以前一样。他们会采用相同的模型。一些工程师会做一个蓝图，你知道，也许会拿着它，在蒸汽机的地方做一个大的X，然后说，不，不，在这里装上电动机。然后他们再去建造一个新的工厂。同样，生产率也不会有大的提高。

It took about 30 years before we started seeing a fundamentally different kind of factory where instead of having the central power source, you know, a big one in the middle, you had distributed power because electric motors, as you guys know, you know, you can make them big, you can make a medium, you can make them really, really small. You can have them all connected in different ways. So they started having each piece of equipment have a separate piece of a separate motor instead of one big one. They called it unit drive instead of group drive. I went and read the books in Baker Library at Harvard Business School from like 1914.  
大约 30 年后，我们才开始看到一种从根本上不同的工厂，它不再是中央电源，你知道，中间的大电源，而是分布式电源，因为电动机，正如你们所知道的，你可以把它们做得很大，你可以把它们做得中等，你可以把它们做得非常非常小。你可以用不同的方式将它们连接起来。因此，他们开始让每台设备都有一个单独的电机，而不是一个大电机。他们称之为单元驱动，而不是分组驱动。我去哈佛商学院贝克图书馆读了1914年的书。

And it was like this whole debate about unit drive versus group drive. Well, when they started doing that, then they had a new layout of factories where it was typically on a single story where the machinery was not based on how much power it needed, but based on the on something else, the flow of materials. And you started having these assembly line systems. That led to a huge improvement in productivity, like a doubling of productivity or tripling in some cases. So the lesson is not that electricity was a fad or dud and was overhyped.  
这就像关于单元驱动和分组驱动的争论一样。当他们开始这样做的时候，他们有了一种新的工厂布局，通常是单层的，机器不是基于它需要多少动力，而是基于其他的东西，材料的流动。你开始有了这些流水线系统。这极大地提高了生产力，在某些情况下，生产力提高了一倍或两倍。因此，我们要吸取的教训并不是说电力是一种时尚或哑弹，被夸大了。

Electricity was a fundamentally valuable technology. But it wasn't until they had that process innovation, that organizational innovation of rethinking how to do production that you got the big payoff. There's a lot of stories like that. I only told you one of them. We don't want that much time.  
电力是一项具有根本价值的技术。但直到他们进行了流程创新、组织创新，重新思考如何进行生产，才获得了巨大的回报。这样的故事有很多。我只说了其中一个。我们不想花那么多时间。

So I tell you the other ones. But in some of my books and articles, if you look at the steam engine and others, you had similar generational lags decades before people realized that this technology could allow you to do something completely different than you used to do. I think AI is a bit like that in some ways, that there's going to be a lot of organizational innovations, going to be new business models, new ways of organizing an economy that we hadn't thought of before. Right now, people are mostly just retrofitting. I could go through a whole other set of skill changes that are complementary.  
所以我告诉你其他的。但在我的一些著作和文章中，如果你看看蒸汽机和其他技术，在人们意识到这项技术可以让你做一些与以往完全不同的事情之前，你会有类似的代际滞后。我认为人工智能在某些方面与此有些类似，将会出现大量的组织创新、新的商业模式、新的经济组织方式，而这些都是我们以前从未想到过的。现在，人们大多只是在改装。我可以列举出其他一系列相辅相成的技能变革。

I don't know what they all are. You have to be creative to think about them. But that's what the gap is. In the case of early computers, it's literally like 10 times more investment in organizational capital and human capital, if you look at the size of the investments, to the hardware and software. So that's very big.  
我不知道它们都是什么。你必须有创造性地去思考它们。但这就是差距所在。就早期的计算机而言，如果从硬件和软件的投资规模来看，在组织资本和人力资本方面的投资简直要高出 10 倍。因此，这是非常大的差距。

That said, I'm open to adjusting my thoughts on this a bit because ChachiPT and some of the other tools, they have been adopted very quickly and they have much more quickly been able to change things, in part because you don't need to learn Python to the same degree. You can do a lot of things just in English. And you can get a lot of value just by putting them on top of the existing organization. So some of it's happening faster. And in some of the papers that you may have read for the readings here, you know, we had like 15, 20, 30% productivity gains pretty quickly.  
尽管如此，我还是愿意稍微调整一下我的想法，因为 ChachiPT 和其他一些工具，它们被采用的速度非常快，而且能够更快地改变现状，部分原因是你不需要学习 Python 就能达到同样的程度。只用英语就能做很多事情。而且，只需将它们放在现有组织之上，就能获得很多价值。所以，有些事情发生得更快。在你可能读过的一些论文中，我们很快就提高了 15%、20%、30% 的生产率。
...
但我的猜测是，一旦人们发现了这些互补性创新，它的规模会更大。以上就是对你问题的回答。这不仅仅是技术技能的问题。而是要找出所有其他的东西，所有重新思考问题的方法。所以，那些在商学院或经济学领域工作的人，你们知道，现在有很多机会重新思考你们的领域，因为你们已经获得了这套惊人的技术。
...
是啊，问题。在转变速度方面，你似乎比埃里克更谨慎。我这么说对吗？嗯，我想区分两件事。在技术方面，我会听从他和其他人的意见。
...
我们还将听到其他几位朋友的发言。在技术方面，有人和他一样乐观，甚至更乐观。也有人不太乐观。但仅仅依靠技术还不足以创造生产力。因此，你可以拥有一项了不起的技术。
...
然后出于各种原因，一是人们可能没有找到有效的使用方法。另一个原因可能是监管问题。我是说，我的一些计算机科学同事引进并开发了更好的放射学系统来读取医学图像。这些系统之所以没有被采用，是因为文化原因，你知道，人们不想要这些系统。他们不想要，也有安全方面的原因。
...
当我分析哪些任务我可以提供最大帮助以及哪些职业受到的影响最大时，我很惊讶地发现，航空公司飞行员几乎排在首位。但我认为，如果没有飞行员和你一起坠机，很多人都会感到不舒服。所以他们希望有人类在里面。所以有很多不同的事情可能会大大降低速度。我认为这是我们需要意识到的。
...
如果我们能解决这些瓶颈问题，对生产力的提升可能会比仅仅研究技术更有意义。对，有问题。埃里克对大学的数据中心有一个有趣的评论。我想这是一个更大的问题，我正想问他为什么不开支票呢？大家都在问他这个问题。
...
大学生态系统的作用是什么？很显然，我相信在座的所有计算机科学教授都有这样的想法。所以，我认为，如果能有更多的资金投入，那就更好了。我的意思是，联邦政府有一个叫国家人工智能资源的东西，它是有一点帮助，但它就像数百万美元，数千万美元，而不是数十亿美元，更不用说数千亿美元了。虽然埃里克在课前跟我提过 他们正在研究一个更大的项目
...
他在争取更大更大的目标我不知道会不会实现那是用来训练这些大型模型的。我曾经和杰夫-辛顿有过一次非常有趣的对话。杰夫-辛顿（Jeff Hinton），大家都知道，他算是深度学习的教父之一。
...
我问他觉得什么样的硬件对他的工作最有用。他坐在笔记本电脑前，轻轻敲了敲他的 MacBook。这提醒了我，大学在其他方面的研究也有竞争优势，比如不是培训价值千亿美元的模型，而是创新新算法，比如《变形金刚》之后的新算法。所以，这可能有点像分工合作。我支持我的同事们为 GPU 争取更多预算，但这并不总是学术界能做出最大贡献的地方。
...
其中一些来自于从不同角度思考问题的想法和新方法，以及新途径。而这可能正是我们的优势所在。上周，我和森德海姆-梅兰纳顿共进晚餐。他刚从芝加哥搬到麻省理工学院。他是一名研究员。
...
我们在讨论大学的比较优势是什么？他提出了一个案例，你知道，耐心就是其中之一，大学里有人在从事非常长期的项目。你知道，有人在研究核聚变。他们研究核聚变已经有很长一段时间了，并不是因为他们会在今年或10年后得到一大笔钱，可能是建造一座核聚变工厂，甚至是20年后。我不知道核聚变还需要多久。
...
但是，你知道，这只是人们愿意为之努力的事情，即使时间上稍有拖延。对于公司来说，要想在时间上有所突破是比较困难的。因此，在大学可以做的事情方面，存在着比较优势或分工。我们还有几分钟时间。这有点意思。
...
所以我们就再问一两个问题。然后我想谈谈这些项目。说吧 Yeah.说吧我是凯文
...
我想知道人工智能的新兴能力。埃里克似乎更倾向于架构差异和设计更好的模型，而不是我们上一堂课谈到的莫尔斯定律。所以我想知道你是如何...他说三者都有你们还记得缩放定律吗？
...
好像有三个部分我想我把达里奥和团队的缩放定律...所以有更多的计算 更多的数据 算法的改进 包括更多的参数我想我听埃里克说过 这三点都很重要但最后一个，比如新架构，我认为这三个都很重要。
...
不过，我觉得还有另一个问题。我们离 AGI 类型系统还有多远？埃里克认为我们离AGI类型系统还没那么近 虽然我不认为这是一个明确的定义你知道，事实上，那是...我本来想问他这个问题 但时间不够了
...
如果能听到他的描述就好了。但当我和他交谈时，他的描述并不那么清晰。从某种程度上说，AGI 已经到来。彼得-诺维格（Peter Norvig）写过一篇文章，叫做 "AGI已经到来"。我不知道它是否在阅读包里。
...
我想如果没有，我就把它放进去。这是一篇有趣的小文章，作者是布莱斯-阿尔卡（Blaise Iarca）。很多事情，20 年前人们会说，这就是 AGI。这也是LLMs正在做的事情。也许做得没那么好，但它是在以一种更普遍的方式解决问题。
...
另一方面，显然有许多事情它们做得比人类差得多。具有讽刺意味的是，体力劳动是人类目前具有比较优势的工作之一。你们可能知道莫拉维克悖论。汉斯-莫拉维克（Hans Moravec）指出，三四岁的孩子都能做的事情，比如扣衬衫扣子或上楼，机器却很难做到。而很多博士都很难做到的事情，比如解决凸优化问题，机器却往往很擅长。
...
因此，并不是所有的事情对人类来说都是容易的，对电脑来说都是困难的，也不是所有的事情对人类来说都是困难的，对电脑来说都是容易的。它们的规模并不相同。下周我们将请到 OpenAI 的首席技术官米拉-莫拉蒂（Mira Morati），简而言之就是 OpenAI 的首席执行官。带着你的问题来找她吧。我们不见不散。
